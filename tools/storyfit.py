...
Two cases matter and they differ: on a choice beat the two option buttons appear
and the Next button goes away, which leaves the box much shorter than usual.
"""
import io, os, re, sys
